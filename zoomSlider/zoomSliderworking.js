...
function ZoomSlider(n) {
    ...
    function kb() {
        var b = 50,
            ...
            a;
        if ((a = c.indexOf("MSIE ")) != -1) b = parseInt(c.substring(a + 5, c.indexOf(".", a)));
        else if ((a = c.indexOf("Chrome")) != -1) b = 50;
        else if ((a = c.indexOf("Safari")) != -1) b = 40;
        else if ((a = c.indexOf("Opera")) != -1) b = 8;
        else b = 50;
        return b
    }
    var I = kb(),
    ...
    f.a = function () {
        ...
        while (a--) {
            if (f[a] && f[a].i) {
                if (B) window.cancelAnimationFrame(f[a].i);
                else clearInterval(f[a].i);
                f[a].i = null
            }
            f[a] = null
        }
    ...
    d.prototype = {
        ...
        h: function (a, b) {
            ...
            if (!this.i) if (B) this.c();
            else this.i = window.setInterval(this.c, this.a.b)
        },
        j: function (a) {
            this.d[this.d[e]] = a;
            return this
        ...
        k: function () {
            for (var b = this.a.e(this.f), a = 0; a < this.d[e]; a++) if (this.d[a].B) this.d[a].B(b);
            else this.d[a](b)
        },
        l: function () {
            ...
            if (Math.abs(a) >= Math.abs(this.f - this.e)) this.f = this.e;
            else this.f += a;
            try {
                this.k()
            } finally {
        ...
        m: function () {
            if (this.i) {
                if (B) window.cancelAnimationFrame(this.i);
                else window.clearInterval(this.i);
                this.i = null;
                this.a.d.call(this)
            }
        },
    ...
    function V(c, b, d, e, a) {
        this.el = c;
        if (b == "opacity" && I < 9 && window.ActiveXObject) this.w = "filter";
        else this.w = b;
        this.x = parseFloat(d);
        this.y = parseFloat(e);
        ...
        B: function (e) {
            if (this.w == "ie" || this.w == "mb") {
                ...
                if (C == l || l < O) {
                    ...
                    l = Math.round(C);
                    if (this.w == "ie") this.el[a][r] = l + "px";
                    else this.el.getContext("2d").drawImage(b.c[b.a], R ? k - l : 0, 0, l, Math.round(l * v / k));
                    return
                }
            }
            var d = this.C(e);
    ...
    var l = -1,
        ...
        K = 1,
        U = 1,
        c, o, p, w, j, m, Q, G, J, D, F, y, db, u, q, k, O, v, M, eb, s, W, i = null,
        X = function () {
            c = {
                b: n.slideInterval,
                O0: n.license,
                c: n.autoAdvance,
                d: n.captionEffect == "none" ? 0 : n.captionEffect == "fade" ? 1 : 2,
                f: n.captionOpacity,
                g: n.thumbnailsWrapperId,
                e: n.thumbEffect,
                v: "thumbs",
                Ob: function () {
    ...
    function cb(d, h) {
        if (I < 9) d[a].filter = "progid:DXImageTransform.Microsoft.BasicImage(grayScale=" + (h == -1 ? 1 : 0) + ")";
        else if (h == -1) {
            var f = A("canvas"),
                g = f.getContext("2d"),
                j = d[r],
    ...
    hb.prototype = {
        c: function (a) {
            if (q[a].nodeName == "IMG") var b = q[a];
            else b = q[a].getElementsByTagName("img")[0];
            return b
        },
        d: function (d) {
            d[a][z] = "block";
        ...
        j: function () {
            if (c.d == 2) {
                var b = "width:0px;marginLeft:" + Math.round(Q[2] / 2) + "px",
                    a = "width:" + Q[2] + "px;marginLeft:0px";
                G = D = "opacity:0;" + b;
                J = "opacity:1;" + a;
                F = "opacity:" + c.f + ";" + a
            } else if (c.d == 1) {
        ...
        p2: function (a) {
            //This has been replaced which makes to work in all web page
a.replace("","$1$3$2")
        },
        l: function (b) {
        ...
        To: function (c) {
            var a;
            if (b.a == 0 && c == -1) a = b.e - 1;
            else if (b.a == b.e - 1 && c == 1) a = 0;
            else a = b.a + c;
            this.t(a)
        }
    };
